...
/** Gepinnter Abschnitt: „Glanz.“ zoomt heran, das Foto wandert durch die Buchstaben. */
export function initGloss() {
  ...
  gsap
    ...
    .fromTo(word, { scale: 0.45, opacity: 0.15, letterSpacing: '0.08em' }, { scale: 1, opacity: 1, letterSpacing: '-0.05em', duration: 1 })
    .fromTo(word, { backgroundPosition: '50% 0%' }, { backgroundPosition: '50% 100%', duration: 1.6 }, 0)
